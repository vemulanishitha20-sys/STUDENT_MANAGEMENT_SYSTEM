...
export default function AnnouncementCenter({ role, userId = "admin", canPublish = false, author, onUnreadChange }) {
  ...
  const publish = async (event) => {
    ...
    localStorage.setItem(STORAGE_KEY, JSON.stringify([saved, ...localAnnouncements()])); setAnnouncements((current) => [saved, ...current]); setTitle(""); setMessage(""); setStatus(""); setShowComposer(false);
  };
